...
- `AbstractMeal.java` — `abstract class Meal` (field, constructor, `abstract int price()`, concrete `label()`), `VegMeal extends Meal` (120) and `JainMeal extends VegMeal` (130); prints `kadhi - 130`. Run: `java AbstractMeal.java`
