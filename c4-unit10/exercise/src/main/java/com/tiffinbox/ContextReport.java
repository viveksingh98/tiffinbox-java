...
public final class ContextReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (AnnotationConfigApplicationContext ctx =
                     new AnnotationConfigApplicationContext(Desks.Config.class)) {
            header(stable, "c4-unit10/exercise");
            ...
            claim("billing.billFor(\"Ravi\")", String.valueOf(
                    ctx.getBean(Desks.Billing.class).billFor("Ravi")));
            claim("delivery.chargeFor(\"Ravi\")", String.valueOf(
                    ctx.getBean(Desks.Delivery.class).chargeFor("Ravi")));
        }
    }

    /** DERIVED off the container's own dependency bookkeeping. */
