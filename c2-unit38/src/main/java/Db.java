...
/// One Db, one shape, every unit in this section: the same URL, the same three
/// constants, the same open() and reset(Connection). Every table the section built
/// is here, and so is the pool — the repository holds dataSource(), never a Connection.
public final class Db {
    ...
    /// The pool, configured exactly as the pooling unit configured it.
    ...
    public static DataSource dataSource() { return POOL; }
