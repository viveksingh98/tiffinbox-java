...
public final class Rails {
    ...
    public static class Config {
        ...
        // The monitor is handed ONE rail, wrapped in a list. The context starts clean and
        // the report says the injected list holds 1, with nothing naming the missing rail.
        @Bean RailMonitor railMonitor(@Qualifier("kitchenRail") OrderQueue one,
                                      Map<String, OrderQueue> byName) {
            return new RailMonitor(List.of(one), byName);
        }
    }
