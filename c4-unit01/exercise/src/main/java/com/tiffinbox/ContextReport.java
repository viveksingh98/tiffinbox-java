...
public final class ContextReport {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try (AnnotationConfigApplicationContext ctx =
            ...
            claim("dashboard.load().customers()",
                    ctx.getBeanNamesForType(Dashboard.class).length == 0
                            ? "no Dashboard bean - still built by hand"
                            : String.valueOf(ctx.getBean(Dashboard.class).load().customers().size()));
