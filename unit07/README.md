...
- `Menu.java` — four String methods on the dish name (`length`, `toUpperCase`, `substring`, `contains`) + immutability (`dish` stays `cottage cheese curry`; store `String shout = dish.toUpperCase()` to keep a result). Run: `java Menu.java`
